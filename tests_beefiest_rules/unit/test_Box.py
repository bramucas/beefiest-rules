...
class TestBox:
    ...
    def test_contains_point(self, custom_box):
        ...
        assert (custom_box.contains_point(
            (2.5, 1, 200)) == False)  # checks false
    ...
    def test_contains_point_feature_names(self, custom_box):
        assert (custom_box.contains_point((3, 70), axis_names=["ax1",
                                                               "ax3"]) == True)
        assert (custom_box.contains_point((3, 70),
                                          axis_names=["ax1", "ax2"]) == False)
